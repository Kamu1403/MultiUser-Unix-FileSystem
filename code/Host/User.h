...
public:
    ...
    void Seek(string fd, string offset, string seek_set);
    void Write(string fd, string in, string size);
    void Read(string fd, string out, string size);
